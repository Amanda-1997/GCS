...
from onpolicy.algorithms.utils.act_graph import ACTLayer
...
class R_Actor(nn.Module):
    ...
    def __init__(self, args, obs_space, action_space, device=torch.device("cpu")):
        ...
        input_dim = self.hidden_size + self.args.n_agents * self.args.n_actions
    ...
    def forward(self, obs, rnn_states, masks, G_s, available_actions=None, deterministic=False):
        ...
        if(self.args.act_graph):
            if self._use_naive_recurrent_policy or self._use_recurrent_policy:
                ...
                actor_features = actor_features.reshape(self.args.n_rollout_threads, -1, self.args.hidden_size)
